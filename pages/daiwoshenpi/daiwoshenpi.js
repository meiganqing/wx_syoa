...
Page({
  ...
  detailUrl: function (e) {
    ...
    switch (module) {
      ...
      case ("绩效差旅表"):
        wx.navigateTo({
          url: '../jxcl_splc/jxcl_splc?id='+ id + '&xmlcid=' + xmlcid + '&onlynum=' + onlynum + '&module=' + module + '&urlid=' + urlid[1]
        })
        break;
      ...
      case ("授权委托表"):
        wx.navigateTo({
          url: '../wts_splc/wts_splc?id='+ id + '&xmlcid=' + xmlcid + '&onlynum=' + onlynum + '&module=' + module + '&urlid=' + urlid[1]
        })
        break;
      // 项目
      case ("wwProject"):
    ...
    SysConfig.UserInfo.GetUserName().then((res) => {
      ...
      SysConfig.SubSystemData.request({
        ...
        data: {
          ...
          "XDLMD":"wwAnnualVacation,考勤补卡表,officialBusiness,visitReception,Appmessage,AppNews,AppBook,wwProject,公文,绩效差旅表,授权委托表",//wwDocument
          "XDLME": "no",
          "XDLMF": "no",
    ...
    if (this.data.load){
      ...
      SysConfig.SubSystemData.request({
        ...
        data: {
          ...
          "XDLMSID": "DYBH201908231020302030130321",
          "XDLME": "no",
          "XDLMD": "wwAnnualVacation,考勤补卡表,officialBusiness,visitReception,Appmessage,AppNews,AppBook,wwProject,公文,绩效差旅表,授权委托表",
          "XDLMF": "no",
          "XDLML": this.data.userid,
