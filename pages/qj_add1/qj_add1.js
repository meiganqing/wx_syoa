  ...
  onLoad: function (options) {
    ...
    if (options.id) {
      ...
      SysConfig.SubSystemData.request({
        ...
        if (data.success) {
          this.setData({
            sDate: SysConfig.ToolBox.CurrentDate() + " " + '00' + ':' + '00' + ':' + '00',
            sDate_data: new Date(SysConfig.ToolBox.CurrentDate() + " " + '00' + ':' + '00' + ':' + '00').getTime()
          })
        }
        // 下午上班时间
        ...
        if (data.success) {
          this.setData({
            eDate: SysConfig.ToolBox.CurrentDate() + " " + '23' + ':' + '59' + ':' + '59',
            eDate_data: new Date(SysConfig.ToolBox.CurrentDate() + " " + '23' + ':' + '59' + ':' + '59').getTime()
          })
          return SysConfig.SubSystemData.request({
            istoken: true,
            XKLX: "SYBGGL",
