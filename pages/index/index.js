...
Page({
  data: {
    ...
    {
      title: '授权委托书',
      img: 'https://syoa.october3d.com/wx/image/weituo.png',
      url: 'wts_add'
    },
    {
      title: '预算申报',
    ...
    SysConfig.UserInfo.GetUserName().then((res) => {
     ...
     SysConfig.SubSystemData.request({
        ...
        data: {
          ...
          "XDLMD": "wwAnnualVacation,考勤补卡表,officialBusiness,公文,visitReception,Appmessage,AppNews,AppBook,wwProject,绩效差旅表,授权委托表",
          "XDLME": "no",
          "XDLMF": "no"
        }
      }).then((res) => {
